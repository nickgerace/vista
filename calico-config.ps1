...
$env:K8S_SERVICE_CIDR = "10.43.0.0/16"
$env:DNS_NAME_SERVERS = "10.43.0.10"
...
# RK - need to  verify that this is the actual name of the CNI config file
